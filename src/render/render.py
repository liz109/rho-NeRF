...
def render(rays, voxels, img_init,\
           net, net_fine, n_samples, n_fine, perturb, netchunk, raw_noise_std,\
            match_mode):
    n_rays = rays.shape[0]
    ...
    ##======================== NAF+ ========================##
    rhos = matcher(pts, voxels, img_init, mode=match_mode)  # [b, n_rays, n_samples, 1] 
    pts = torch.cat((pts, rhos), dim=-1)    # [b, n_rays, n_samples, 4]
    ##======================== NAF+ ========================##
